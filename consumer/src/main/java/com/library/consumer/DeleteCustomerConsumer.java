...
public class DeleteCustomerConsumer {
    ...
    public DeleteCustomerConsumer(String groupName, String streamName) throws IOException {
        objectMapper = new ObjectMapper();
        mySqlStorage = new MySqlStorage();
        consumerInit = new ConsumerInit();
        kafkaConsumer = consumerInit.streamInit(groupName, streamName);
        deleteCustomerStreamProcessor();
    }

    private void deleteCustomerStreamProcessor() throws IOException{
        while (true) {
